        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <nav className="flex flex-col gap-3">
              ...
              <Link href="/live-code" className="text-muted-foreground hover:text-primary transition-colors">Live Code</Link>
            </nav>
          </div>
          ...
          <div>
            ...
            <nav className="flex flex-col gap-3">
              ...
              <Link href="/api-docs" className="text-muted-foreground hover:text-primary transition-colors">API Docs</Link>
